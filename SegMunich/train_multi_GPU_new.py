...
if __name__ == "__main__":
    ...
    # 训练文件的根目录(DRIVE)
    parser.add_argument('--data-path', default="/root/projects/IEEE_TPAMI_SpectralGPT/TUM_128", help='dataset')
    # 训练设备类型
    ...
    parser.add_argument("--pretrain-path", default="/root/projects/IEEE_TPAMI_SpectralGPT/SpectralGPT+.pth")
