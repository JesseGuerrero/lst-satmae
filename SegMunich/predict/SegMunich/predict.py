...
from src.models_vit_tensor_CD import vit_base_patch8
import numpy as np
...
def main():
    classes = 1
    weights_path = "/root/projects/IEEE_TPAMI_SpectralGPT/downstream_predict/SegMunich/model_3con_loss51_0.pth"
    ...
    # create model
    model = vit_base_patch8(num_classes=12)
    ...
    # load image
    image_folder_path = "/root/projects/IEEE_TPAMI_SpectralGPT/downstream_predict/TUM/img"
    ...
    for image_file_name in image_file_names:
        ...
        with torch.no_grad():
            ...
            mask.save(os.path.join("/root/projects/IEEE_TPAMI_SpectralGPT/downstream_predict/TUM/predict/", image_file_name))
